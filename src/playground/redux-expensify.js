...
const getVisibleExpenses = (expenses, { text, sortBy, startDate, endDate }) => {
    return expenses.filter((expense) => {
        const startDateMatch = typeof expense.startDate !== 'number' || expense.createAt >= startDate;
        const endDateMatch = typeof expense.endDate !== 'number' || expense.createAt <= endDate;
